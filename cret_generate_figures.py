...
## Plot dwells
#here, build a plot of the average nr of unique dwells broekn down by trial type


#now the break down by each type of substanc chosen
fig = figure(figsize = (12.8,7.64)); ax1=gca(); #grid(True);
ax1.set_xlim([0.4,3.0]); ax1.set_xticks([1,1.7,2.4]); #ax1.set_ylim(0.,0.6); ax1.set_yticks(arange(0,0.601,0.05)); 
ax1.set_ylabel('Average number of dwells ',size=18); ax1.set_xlabel('Substance',size=18,labelpad=15);
ax1.set_xticklabels(['Alcohol Selected','Cigarette Selected','Neutral Selected']);
colors=['red','blue','green'];


#alcohol selected first
ax1.bar(0.8,db['%s_%s_chose_alc_alc_mean_nr_fix'%(eyed,name)], color = colors[0], width = 0.2);
ax1.errorbar(0.8, db['%s_%s_chose_alc_alc_mean_nr_fix'%(eyed,name)],
             yerr=[[db['%s_%s_chose_alc_alc_bs_sems_nr_fix'%(eyed,name)]],[db['%s_%s_chose_alc_alc_bs_sems_nr_fix'%(eyed,name)]]],color='black',lw=6.0); #, capsize = 7.0
ax1.bar(1.0,db['%s_%s_chose_alc_cig_mean_nr_fix'%(eyed,name)], color = colors[1], width = 0.2);
ax1.errorbar(1.0, db['%s_%s_chose_alc_cig_mean_nr_fix'%(eyed,name)],
             yerr=[[db['%s_%s_chose_alc_cig_bs_sems_nr_fix'%(eyed,name)]],[db['%s_%s_chose_alc_cig_bs_sems_nr_fix'%(eyed,name)]]],color='black',lw=6.0); 
ax1.bar(1.2,db['%s_%s_chose_alc_neu_mean_nr_fix'%(eyed,name)], color = colors[2], width = 0.2);
ax1.errorbar(1.2, db['%s_%s_chose_alc_neu_mean_nr_fix'%(eyed,name)],
             yerr=[[db['%s_%s_chose_alc_neu_bs_sems_nr_fix'%(eyed,name)]],[db['%s_%s_chose_alc_neu_bs_sems_nr_fix'%(eyed,name)]]],color='black',lw=6.0); 

#cigarettes next
ax1.bar(1.5,db['%s_%s_chose_cig_alc_mean_nr_fix'%(eyed,name)], color = colors[0], width = 0.2);
ax1.errorbar(1.5, db['%s_%s_chose_cig_alc_mean_nr_fix'%(eyed,name)],
             yerr=[[db['%s_%s_chose_cig_alc_bs_sems_nr_fix'%(eyed,name)]],[db['%s_%s_chose_cig_alc_bs_sems_nr_fix'%(eyed,name)]]],color='black',lw=6.0); #, capsize = 7.0
ax1.bar(1.7,db['%s_%s_chose_cig_cig_mean_nr_fix'%(eyed,name)], color = colors[1], width = 0.2);
ax1.errorbar(1.7, db['%s_%s_chose_cig_cig_mean_nr_fix'%(eyed,name)],
             yerr=[[db['%s_%s_chose_cig_cig_bs_sems_nr_fix'%(eyed,name)]],[db['%s_%s_chose_cig_cig_bs_sems_nr_fix'%(eyed,name)]]],color='black',lw=6.0); 
ax1.bar(1.9,db['%s_%s_chose_cig_neu_mean_nr_fix'%(eyed,name)], color = colors[2], width = 0.2);
ax1.errorbar(1.9, db['%s_%s_chose_cig_neu_mean_nr_fix'%(eyed,name)],
             yerr=[[db['%s_%s_chose_cig_neu_bs_sems_nr_fix'%(eyed,name)]],[db['%s_%s_chose_cig_neu_bs_sems_nr_fix'%(eyed,name)]]],color='black',lw=6.0); 

#neutral finally
ax1.bar(2.2,db['%s_%s_chose_neu_alc_mean_nr_fix'%(eyed,name)], color = colors[0], width = 0.2);
ax1.errorbar(2.2, db['%s_%s_chose_neu_alc_mean_nr_fix'%(eyed,name)],
             yerr=[[db['%s_%s_chose_neu_alc_bs_sems_nr_fix'%(eyed,name)]],[db['%s_%s_chose_neu_alc_bs_sems_nr_fix'%(eyed,name)]]],color='black',lw=6.0); #, capsize = 7.0
ax1.bar(2.4,db['%s_%s_chose_neu_cig_mean_nr_fix'%(eyed,name)], color = colors[1], width = 0.2);
ax1.errorbar(2.4, db['%s_%s_chose_neu_cig_mean_nr_fix'%(eyed,name)],
             yerr=[[db['%s_%s_chose_neu_cig_bs_sems_nr_fix'%(eyed,name)]],[db['%s_%s_chose_neu_cig_bs_sems_nr_fix'%(eyed,name)]]],color='black',lw=6.0); 
ax1.bar(2.6,db['%s_%s_chose_neu_neu_mean_nr_fix'%(eyed,name)], color = colors[2], width = 0.2);
ax1.errorbar(2.6, db['%s_%s_chose_neu_neu_mean_nr_fix'%(eyed,name)],
             yerr=[[db['%s_%s_chose_neu_neu_bs_sems_nr_fix'%(eyed,name)]],[db['%s_%s_chose_neu_neu_bs_sems_nr_fix'%(eyed,name)]]],color='black',lw=6.0); 
...
filename = '%s_by_choice_nr_unique_dwells';
...
ax1.set_xlim([0.5,1.7]); ax1.set_xticks([0.85, 1.15, 1.45]); #ax1.set_ylim(0, 0.8); ax1.set_yticks(arange(0, 0.81, 0.1));
...
colors=['red','blue','green'];
ax1.bar(0.85,db['%s_%s_alc_mean_nr_fix'%(eyed,name)], color = colors[0], width = 0.25);
ax1.errorbar(0.85, db['%s_%s_alc_mean_nr_fix'%(eyed,name)],
             yerr=[[db['%s_%s_alc_bs_sems_nr_fix'%(eyed,name)]],[db['%s_%s_alc_bs_sems_nr_fix'%(eyed,name)]]],color='black',lw=6.0,capsize = 0);
ax1.bar(1.15,db['%s_%s_cig_mean_nr_fix'%(eyed,name)], color = colors[1], width = 0.25);
ax1.errorbar(1.15, db['%s_%s_cig_mean_nr_fix'%(eyed,name)],
             yerr=[[db['%s_%s_cig_bs_sems_nr_fix'%(eyed,name)]],[db['%s_%s_cig_bs_sems_nr_fix'%(eyed,name)]]],color='black',lw=6.0,capsize = 0);
ax1.bar(1.45,db['%s_%s_neu_mean_nr_fix'%(eyed,name)], color = colors[2], width = 0.25);
ax1.errorbar(1.45, db['%s_%s_neu_mean_nr_fix'%(eyed,name)],
             yerr=[[db['%s_%s_neu_bs_sems_nr_fix'%(eyed,name)]],[db['%s_%s_neu_bs_sems_nr_fix'%(eyed,name)]]],color='black',lw=6.0,capsize = 0);
ax1.spines['right'].set_visible(False); ax1.spines['top'].set_visible(False);
ax1.spines['bottom'].set_linewidth(2.0); ax1.spines['left'].set_linewidth(2.0);
ax1.yaxis.set_ticks_position('left'); ax1.xaxis.set_ticks_position('bottom');
#save the labeled figure as a .png	
filename = '%s_nr_uniqe_dwells'%name;
savefig(savepath+filename+'.png',dpi=400);
