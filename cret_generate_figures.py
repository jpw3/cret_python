...
#alcohol first
ax1.bar(1.0,db['%s_high_pref_all_hp_look_at_alc_mean_perc_time_at_pref'%eyed], color = colors[0], width = 0.4);
...
#cigarettes next
ax1.bar(1.7,db['%s_high_pref_all_hp_look_at_cig_mean_perc_time_at_pref'%eyed], color = colors[1], width = 0.4);
...
#finally neutral
ax1.bar(2.4,db['%s_high_pref_all_hp_look_at_neutral_mean_perc_time_at_pref'%eyed], color = colors[2], width = 0.4);
