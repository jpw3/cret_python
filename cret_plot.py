...
ax1.errorbar(1.0, db['%s_high_pref_selected_cue_look_at_not_cue_mean_perc_time_at_pref'%eyed],
             yerr=[[db['%s_high_pref_selected_cue_look_at_not_cue_bs_sems_perc_time_at_pref'%eyed]],[db['%s_high_pref_selected_cue_look_at_not_cue_bs_sems_perc_time_at_pref'%eyed]]],color='black',lw=6.0);
ax1.bar(1.2,db['%s_high_pref_selected_cue_look_at_neutral_mean_perc_time_at_pref'%eyed], color = colors[2], width = 0.2);
ax1.errorbar(1.2, db['%s_high_pref_selected_cue_look_at_neutral_mean_perc_time_at_pref'%eyed],
...
ax1.errorbar(1.7, db['%s_high_pref_selected_not_cue_look_at_not_cue_mean_perc_time_at_pref'%eyed],
...
ax1.errorbar(1.9, db['%s_high_pref_selected_not_cue_look_at_neutral_mean_perc_time_at_pref'%eyed],
...
ax1.bar(2.2,db['%s_high_pref_selected_neutral_look_at_cue_mean_perc_time_at_pref'%eyed], color = colors[0], width = 0.2);
ax1.errorbar(2.2, db['%s_high_pref_selected_neutral_look_at_cue_mean_perc_time_at_pref'%eyed],
             yerr=[[db['%s_high_pref_selected_neutral_look_at_cue_bs_sems_perc_time_at_pref'%eyed]],[db['%s_high_pref_selected_neutral_look_at_cue_bs_sems_perc_time_at_pref'%eyed]]],color='black',lw=6.0);
ax1.bar(2.4,db['%s_high_pref_selected_neutral_look_at_not_cue_mean_perc_time_at_pref'%eyed],  color = colors[1], width = 0.2);
ax1.errorbar(2.4, db['%s_high_pref_selected_neutral_look_at_not_cue_mean_perc_time_at_pref'%eyed],
             yerr=[[db['%s_high_pref_selected_neutral_look_at_not_cue_bs_sems_perc_time_at_pref'%eyed]],[db['%s_high_pref_selected_neutral_look_at_not_cue_bs_sems_perc_time_at_pref'%eyed]]],color='black',lw=6.0);
