...
ax1.set_ylim(0.25,0.75); ax1.set_yticks(arange(0.30,0.751,0.05)); ax1.set_xlim([0.7,3.1]); ax1.set_xticks([1,1.6,2.2,2.8]);
ax1.set_ylabel('Proportion of time fixating preferred item',size=18); ax1.set_xlabel('Condition',size=18,labelpad=15);
ax1.set_xticklabels(['All PAPC Trials','PAPC, Cue Selected','PAPC, Other Substance Selected','PAPC, Neutral Selected']);
colors=['blue'];
...
ax1.bar(1.6,db['%s_%s_selected_%s_mean_perc_time_at_pref'%('agg','high_pref','cue')],color=colors[0],width=0.3);
ax1.errorbar(1.6,db['%s_%s_selected_%s_mean_perc_time_at_pref'%('agg','high_pref','cue')],
...
ax1.bar(2.2,db['%s_%s_selected_%s_mean_perc_time_at_pref'%('agg','high_pref','not_cue')],color=colors[0],width=0.3);
ax1.errorbar(2.2,db['%s_%s_selected_%s_mean_perc_time_at_pref'%('agg','high_pref','not_cue')],
...
ax1.bar(2.8,db['%s_high_pref_%s_mean_perc_time_at_pref'%('agg','neutral')],color=colors[0],width=0.3);
ax1.errorbar(2.8,db['%s_high_pref_%s_mean_perc_time_at_pref'%('agg','neutral')],
...
title('Proportion of time fixating preferred item for preferred alcohol/preferred cigarette \n  (PAPC) trials depending on whether cue item was selected', fontsize = 22);
...
fig = figure(figsize = (12.8,7.64)); ax1=gca(); #grid(True);
ax1.set_ylim(0.25,0.75); ax1.set_yticks(arange(0.30,0.751,0.05)); ax1.set_xlim([0.7,3.1]); ax1.set_xticks([1,1.6,2.2,2.8]);
ax1.set_ylabel('Proportion of trials last fixated item was selected',size=18); ax1.set_xlabel('Condition',size=18,labelpad=15);
ax1.set_xticklabels(['All PAPC Trials','PAPC, Cue Selected','PAPC, Other Substance Selected','PAPC, Neutral Selected']);
colors=['green'];
...
ax1.bar(1.6,db['%s_%s_selected_%s_mean_prop_last_fixated_item'%('agg','high_pref','cue')],color=colors[0],width=0.3);
ax1.errorbar(1.6,db['%s_%s_selected_%s_mean_prop_last_fixated_item'%('agg','high_pref','cue')],
...
ax1.bar(2.2,db['%s_%s_selected_%s_mean_prop_last_fixated_item'%('agg','high_pref','not_cue')],color=colors[0],width=0.3);
ax1.errorbar(2.2,db['%s_%s_selected_%s_mean_prop_last_fixated_item'%('agg','high_pref','not_cue')],
...
ax1.bar(2.8,db['%s_high_pref_%s_mean_prop_last_fixated_item'%('agg','neutral')],color=colors[0],width=0.3);
ax1.errorbar(2.8,db['%s_high_pref_%s_mean_prop_last_fixated_item'%('agg','neutral')],
...
ax1.spines['bottom'].set_linewidth(2.0); ax1.spines['left'].set_linewidth(2.0);
ax1.yaxis.set_ticks_position('left'); ax1.xaxis.set_ticks_position('bottom');
title('Proportion of trials fixating the selected item last\n for preferred alcohol/preferred cigarette (PAPC) trials depending on\n whether cue item was selected', fontsize = 22);
#save the labeled figure as a .png	
